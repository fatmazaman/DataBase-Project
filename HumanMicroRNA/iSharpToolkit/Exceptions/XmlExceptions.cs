...
namespace iSharpToolkit.Exceptions
{
    //XmlExceptions : XElement
    /// <summary>Represent an Exception as XML data.</summary>
    public class XmlExceptions : XElement
    {
        /// <summary>Create an instance of ExceptionXElement.</summary>
        /// <param name="exception">The Exception to serialize.</param>
        public XmlExceptions(Exception exception)
        ...
        /// if it's not null.
        /// </param>
        public XmlExceptions(Exception exception, bool omitStackTrace)
