<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="HumanMicroRNA.Admin.Login" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script src="Assets/JScript/ModalPopUp.js" type="text/javascript"></script>
    <script src="Assets/JScript/jquery.min.js" type="text/javascript"></script>
</asp:Content>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0">
                        <tr valign="bottom">
                            ...
                            <td width="20%" align="center">
                                <asp:Button ID="btnSubmitReset" runat="server" Text="Submit" CssClass="submit_button" OnClick="btnSubmitReset_Click" />
                            </td>
                        </tr>
                    </table>
                </td>
